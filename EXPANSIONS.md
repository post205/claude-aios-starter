...
The kit ships lean on purpose. Three skills, six folders, two framework references. That's it. As you use it, you'll outgrow the base — this guide tells you what to add, when, and why.
...
| `references/` | The two frameworks (`the-shift.md`, `the-stack.md`), plus voice samples, API guides, and SOPs as you build them. |
